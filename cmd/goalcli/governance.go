...
func runVersion(args []string, stdout io.Writer, stderr io.Writer) int {
	...
	return emitReport(stdout, "version", "passed", []string{"contracts release " + projectReleaseVersion, "goalcli governance runtime " + governanceRuntimeVersion, "goalcli governance CLI available"}, nil)
}
